//! Reproduces the unvalidated bounty recipient found in the internal review of
//! the on-chain programs (wienerlabs/leviathan#15).
//!
...
const RUN_ID: &str = "Leviathan bounty recipient";
const BOND: u64 = 500;
